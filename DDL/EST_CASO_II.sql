...
ALTER TABLE AEROPORTOS ADD AEROPORTO_CONTINENTE VARCHAR(35);
ALTER TABLE AEROPORTOS DROP AEROPORTO_LOCAL;
ALTER TABLE AEROPORTOS MODIFY AEROPORTO_NOME VARCHAR(40) NOT NULL;
...
ALTER TABLE AERONAVES MODIFY AERONAVE_MODELO VARCHAR(40) NOT NULL;
...
ALTER TABLE FUNCIONARIOS MODIFY FUNC_NOME VARCHAR(70) NOT NULL;
