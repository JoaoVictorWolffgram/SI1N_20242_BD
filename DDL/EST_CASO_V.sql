...
STATUS_FIDEL_CLIENTE VARCHAR(35) NOT NULL
);
...
ALTER TABLE PRODUTOS CHANGE COLUMN PRECO_PROD VALOR_PROD DECIMAL(20,2) NOT NULL;

ALTER TABLE CLIENTES ADD EMAIL_CLIENTE VARCHAR(35) NOT NULL;
ALTER TABLE CLIENTES DROP COLUMN BAIRRO_CLIENTE;
ALTER TABLE CLIENTES MODIFY COLUMN STATUS_FIDEL_CLIENTE VARCHAR(70) NOT NULL;
ALTER TABLE CLIENTES CHANGE COLUMN NOME COMP_CLIENTE VARCHAR(70) NOT NULL;

ALTER TABLE FORNECEDORES ADD FORNEC_CONTATO TEXT NOT NULL;
ALTER TABLE FORNECEDORES DROP COLUMN FORNEC_RUA VARCHAR(35) NOT NULL;
ALTER TABLE FORNECEDORES MODIFY COLUMN NUM_RUA_FORN INT NOT NULL,
ALTER TABLE FORNECEDORES CHANGE COLUMN  NUM_RUA_FORN RUA_NUM_FORN INT NOT NULL;
