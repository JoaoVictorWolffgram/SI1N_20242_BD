...
COMP_UNIDADE VARCHAR(40) NOT NULL
);
...
ALTER TABLE CLIENTES DROP CNPJ_CLIENTE;
ALTER TABLE CLIENTES MODIFY NOME_CLIENTE VARCHAR(70) NOT NULL;
...
ALTER TABLE EMPREGADOS MODIFY EMPREGADO_NOME VARCHAR(70) NOT NULL;
...
ALTER TABLE FORNECEDORES MODIFY FORN_PESSOA_CONTATO VARCHAR(70) NOT NULL;

ALTER TABLE PRODUTOS ADD PROD_DESCRICAO TEXT;
ALTER TABLE PRODUTOS DROP PROD_COR;
ALTER TABLE PRODUTOS MODIFY PROD_NOME VARCHAR(70) NOT NULL;
ALTER TABLE PRODUTOS CHANGE PROD_PRECO PROD_PRECO_NOVO DECIMAL(20, 2) NOT NULL;
...
ALTER TABLE COMPONENTES CHANGE COMP_PRECO_UNITARIO COMP_PRECO_UNITARIO_NOVO DECIMAL(20, 2) NOT NULL;
...
ALTER TABLE RM ADD RM_RESPONSAVEL VARCHAR(60);
ALTER TABLE RM DROP RM_DATA;
ALTER TABLE RM MODIFY RM_DESCRICAO DATE NOT NULL;
ALTER TABLE RM CHANGE RM_DESCRICAO RM_DESCRICAO_COMPLETA VARCHAR(150) NOT NULL;
