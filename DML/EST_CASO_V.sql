...
(123456789, 'João Silva', '1990-05-15', 'SIM', 'Rua A', 123, 'Centro', 'Rio de Janeiro', 'RJ', 'Brasil', 'joao.silva@email.com');
(987654321, 'Maria Oliveira', '1985-11-22', 'NÃO', 'Rua B', 456, 'Icaraí', 'Niterói', 'RJ', 'Brasil', 'maria.oliveira@email.com');
(112233445, 'Ana Costa', '1992-03-12', 'SIM', 'Rua C', 789, 'Centro', 'Belo Horizonte', 'MG', 'Brasil', 'ana.costa@email.com');
(556677889, 'Lucas Lima', '1993-07-05', 'SIM', 'Rua D', 101, 'Centro', 'São Paulo', 'SP', 'Brasil', 'lucas.lima@email.com');
(667788990, 'Carlos Pereira', '1991-12-19', 'NÃO', 'Rua E', 202, 'Jardim', 'Curitiba', 'PR', 'Brasil', 'carlos.pereira@email.com');
...
(2, 987654321, 'Fornecedor B', 'Produto Y', 'Descrição do Produto B');
(3, 111223344, 'Fornecedor C', 'Produto Z', 'Descrição do Produto C');
(4, 555667788, 'Fornecedor D', 'Produto W', 'Descrição do Produto D');
(5, 999887766, 'Fornecedor E', 'Produto V', 'Descrição do Produto E');

INSERT INTO ESTOQUE (ID_ESTOQUE, PROD_ESTOQUE, LOC_PROD_ESTOQUE, QNT_PROD_ESTOQUE, PROD_DISP_ESTOQUE) VALUES
(1, 'Produto X', 'Local A', 100, 50);
(2, 'Produto Y', 'Local B', 200, 150);
(3, 'Produto Z', 'Local C', 150, 100);
(4, 'Produto W', 'Local D', 80, 60);
(5, 'Produto V', 'Local E', 120, 90);

INSERT INTO VENDA (ID_VENDA, PROD_VENDA, QNT_PROD_VENDA, PAGAMENTO_VENDA, CLIENTE_VENDA, DATA_VENDA) VALUES
(1, 'Produto X', 1, 'Dinheiro', 123456789, '2024-11-01');
(2, 'Produto Y', 3, 'Cartão de Crédito', 987654321, '2024-11-02');
(3, 'Produto Z', 2, 'Pix', 112233445, '2024-11-03');
(4, 'Produto W', 4, 'Boleto', 556677889, '2024-11-04');
(5, 'Produto V', 5, 'Dinheiro', 667788990, '2024-11-05');
...
(1, 123456789, '2024-11-01', 100, 'PENDENTE', 123456789);
(2, 987654321, '2024-11-02', 200, 'PAGO', 987654321);
(3, 112233445, '2024-11-03', 300, 'PENDENTE', 112233445);
(4, 556677889, '2024-11-04', 400, 'PAGO', 556677889);
(5, 667788990, '2024-11-05', 500, 'PENDENTE', 667788990);
...
DELETE FROM CLIENTES WHERE CPF_CLIENTE = 987654321;
